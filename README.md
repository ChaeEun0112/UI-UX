...
![Intro](https://github.com/ChaeEun0112/UI-UX/blob/main/Intro.png)
## 💬의미
...
## 👩‍💻 담당 역할
- 앱 서비스 기획 및 UX 흐름 설계
- Adobe XD를 활용한 모바일 UI 디자인
- 레시피 탐색을 위한 카테고리 구조 설계
- 사용자 편의를 고려한 네비게이션 구조 설계
- 레시피, 재료, 도구 정보를 통합한 화면 구성
## 🎨제작 과정
